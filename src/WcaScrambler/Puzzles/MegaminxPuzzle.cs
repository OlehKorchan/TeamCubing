...
public class MegaminxPuzzle : Puzzle
{
    ...
    private static void SwapOnSide(
        int[][] image,
        int b,
        int f1,
        int s1,
    ...
    private static void SwapWholeFace(
        int[][] image,
        int f1,
        int s1,
        int f2,
    ...
    {
        return image[(int)Face.U][CenterIndex] == (int)Face.U &&
               image[(int)Face.F][CenterIndex] == (int)Face.F;
    }
    ...
    internal class MegaminxState : PuzzleState
    {
        ...
        {
            _puzzle = p;
            Image = ArrayExtension.New<int>(12, 11);
        ...
        {
            return _normalizedState ??= new MegaminxState(Normalize(Image), _puzzle);
        }

        public override bool IsNormalized()
        {
            return MegaminxPuzzle.IsNormalized(Image);
        }
